...
@Profile({"capacity-service-aws-redis", "capacity-service-aws-stub", "doswrapper-local-dos-stub-na-cpsc-rest-local",
...
@Component
public class CapacityReportingServiceClientProd implements CapacityReportingServiceClient
{

    private static final Logger logger = LoggerFactory.getLogger(CapacityReportingServiceClientProd.class);
